    ...
    <div className="bg-black text-white min-h-screen font-sans">
      ...
      <section className="relative flex flex-col items-center justify-center text-center px-6 py-24">
        <h1 className="text-5xl md:text-6xl font-extrabold mb-6 leading-tight">
          Spot <span className="text-yellow-400">100x Meme Coins</span> Before
          Anyone Else
        </h1>
        <p className="text-lg md:text-xl text-gray-300 max-w-2xl mb-8">
          Turn chaos into clarity. Analyze real-time on-chain data from{" "}
          <span className="font-semibold text-yellow-400">pump.fun</span> and
          trade smarter with alerts, charts, and scam protection built for meme
          traders.
        </p>
        <a
          href="#get-started"
          className="bg-yellow-400 text-black px-6 py-3 rounded-2xl font-semibold flex items-center gap-2 hover:bg-yellow-300 transition"
        >
        ...
        <div className="grid md:grid-cols-2 gap-10 max-w-5xl mx-auto text-left">
          <div className="bg-black p-6 rounded-2xl shadow-lg">
            ...
            <p className="text-gray-400">
              ...
              meme coin pages. Compare price action with unique signals for
              better setups.
            </p>
          </div>
          <div className="bg-black p-6 rounded-2xl shadow-lg">
            <h3 className="text-2xl font-semibold mb-3">Alert Extension</h3>
            <p className="text-gray-400">
      ...
      <section
        id="get-started"
        className="px-6 py-20 bg-yellow-400 text-black text-center"
      >
        ...
        <a
          href="#"
          className="bg-black text-white px-6 py-3 rounded-2xl font-semibold flex items-center gap-2 mx-auto w-fit hover:bg-gray-800 transition"
        >
      ...
      <footer className="px-6 py-10 bg-black text-gray-500 text-center text-sm">
        © {new Date().getFullYear()} Meme Coin Tools. All rights reserved.
      </footer>
    </div>
  );
}
